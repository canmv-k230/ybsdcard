...
class ItemCountPage(BaseDemoPage):
    ...
    def get_image_source(self):
        # 返回图片源
        try:
            with open("/sdcard/apps/color_det/item_count/banner.png", 'rb') as f:
                img_cache = f.read()
                return lv.img_dsc_t({
    ...
    def get_title(self):
        return self.text_config.get_section("ColorDet")["item_count"]["title"]
    
    def get_description(self):
        return self.text_config.get_section("ColorDet")["item_count"]["info"]
