...
import apps.color_det.multi_color_recog.recog as multi_color_recogection
from media.display import *
from media.media import *

class MultiColorRecogPage(BaseDemoPage):
    ...
    def get_image_source(self):
        # 返回图片源
        try:
            with open("/sdcard/apps/color_det/multi_color_recog/banner.png", 'rb') as f:
                img_cache = f.read()
                return lv.img_dsc_t({
    ...
    def get_title(self):
        return self.text_config.get_section("ColorDet")["multi_color_recog"]["title"]
    
    def get_description(self):
        return self.text_config.get_section("ColorDet")["multi_color_recog"]["info"]
    ...
    def on_button_click(self, evt):
        ...
        self.run_demo(multi_color_recogection)
