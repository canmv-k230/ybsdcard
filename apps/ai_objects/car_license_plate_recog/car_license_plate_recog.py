...
import apps.ai_objects.car_license_plate_recog.car_license_plate_recognition as car_license_plate_recognition
from media.display import *
from media.media import *
import machine

class CLPRPage(BaseDemoPage):
    ...
    def get_image_source(self):
        # 返回图片源
        try:
            with open("/sdcard/apps/ai_objects/car_license_plate_recog/banner.png", 'rb') as f:
                img_cache = f.read()
                return lv.img_dsc_t({
    ...
    def get_title(self):
        return self.text_config.get_section("AI_objects")["car_license_plate_recog"]["title"]
    
    def get_description(self):
        return self.text_config.get_section("AI_objects")["car_license_plate_recog"]["info"]
    ...
    def on_button_click(self, evt):
        ...
        self.run_demo(car_license_plate_recognition)