...
class YoloSegPage(BaseDemoPage):
    ...
    def get_image_source(self):
        # 返回图片源
        try:
            with open("/sdcard/apps/ai_objects/yolov8n_seg/banner.png", 'rb') as f:
                img_cache = f.read()
                return lv.img_dsc_t({
    ...
    def get_title(self):
        return self.text_config.get_section("AI_objects")["yolov8n_seg"]["title"]
    
    def get_description(self):
        return self.text_config.get_section("AI_objects")["yolov8n_seg"]["info"]
