...
import apps.code_det.barcode_recog.barcode_recognition as barcode_recognition
from media.display import *
from media.media import *

class BarRecogPage(BaseDemoPage):
    ...
    def get_image_source(self):
        # 返回图片源
        try:
            with open("/sdcard/apps/code_det/barcode_recog/banner.png", 'rb') as f:
                img_cache = f.read()
                return lv.img_dsc_t({
    ...
    def get_title(self):
        return self.text_config.get_section("CodeDet")["barcode_recog"]["title"]
    
    def get_description(self):
        return self.text_config.get_section("CodeDet")["barcode_recog"]["info"]
    ...
    def on_button_click(self, evt):
        ...
        self.run_demo(barcode_recognition)
